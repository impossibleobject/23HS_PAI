...
class Agent:
    ...
    def train_agent(self): 
        ...
        with torch.no_grad():
            ...
            qf1_next = self.targetc_net1.network(state_action)   
            qf2_next = self.targetc_net2.network(state_action)
        ...
        reward_pred_1 = self.critic_net1.network(input_Q)
        reward_pred_2 = self.critic_net2.network(input_Q)
        ...
        self.critic_target_update(self.critic_net1.network, 
                                  self.targetc_net1.network,
                                    self.Tau,True)
        self.critic_target_update(self.critic_net2.network, 
                                  self.targetc_net2.network, 
                                  self.Tau,True)
